      ...
      * implements Iterative, Connectionless Server Algorithm
       ...
       MAINLINE.
           ...
           MOVE 'LISTEN03' TO EZA-PROGRAM
           MOVE 5003       TO EZA-NAME-PORT
       ...
       RECV-START.
           ...
           if EZA-RETCODE EQUAL 0
              ...
              if EZA-BUFFER(1:EZA-RETCODE) EQUAL
                 'TEST SEND FROM SEND0003'
                 DISPLAY 'PASS: expected return from send0003.cbl'
              else
                 DISPLAY 'FAIL: unexpected return from send0003.cbl'
              end-if
              DISPLAY 'COMPLETE'
           end-if
           .
