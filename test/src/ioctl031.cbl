      ...
      * test command FIONBIO
           ...
           01 IOCTL-DATA.
              ...
              05 IOCTL-BYTESFORREAD   PIC 9(8) COMPBINARY.

       PROCEDURE DIVISION.

       MAINLINE.

           MOVE 'IOCTL031' TO EZA-PROGRAM
           MOVE 5031       TO EZA-NAME-PORT
      ...
      *     MOVE X'4004A77F' TO IOCTL-COMMAND-STR
           MOVE 1074046847 TO IOCTL-COMMAND
           MOVE 0 TO IOCTL-BYTESFORREAD
           MOVE +0 TO EZA-ERRNO
           MOVE +0 TO EZA-RETCODE
           CALL 'EZASOKET'
               USING
           ...
           ELSE
              IF IOCTL-BYTESFORREAD = 23
                 DISPLAY 'PASS: IOCTL returned ' IOCTL-BYTESFORREAD
              ELSE
                 DISPLAY 'FAIL: IOCTL returned ' IOCTL-BYTESFORREAD
              END-IF
